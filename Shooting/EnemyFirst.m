...
-(id) initWithBatchNode:(CCSpriteBatchNode*)batchNode{
    ...
    self = [super initWithTexture:batchNode.texture rect:CGRectMake(0, 200, 30, 30)];
    hp = 20;
    power = 10;
    exp = 1;
    money = 10;
    ...
    level = 1;
    for(int i=0 ; i < 8 ; i++){
        appearFrame[i] = [[CCSpriteFrame alloc] initWithTexture:batchNode.texture rect:CGRectMake(70 * i, 0, 70, 70)];
        appearFrameCount = i;
    }
    for(int i=0 ; i < 8 ; i++){
        moveFrame[i] = [[CCSpriteFrame alloc] initWithTexture:batchNode.texture rect:CGRectMake(30 * i, 70, 30, 50)];
        moveFrameCount = i;
    }
